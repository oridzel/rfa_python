#!/usr/bin/env python3
\"\"\"
Repair the emitted-electron grazing patch so it works with track_points=False.

Usage:
    python fix_grazing_track_points.py rfa_model/trajectories.py

This only edits the block marked:
